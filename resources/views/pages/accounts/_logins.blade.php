            ...
            <div class="w-full max-w-lg p-4 max-w-auto box-shadow-lg">
                ...
                <form action="{{ route('login') }}" method="post">
                    ...
                    <div class="py-4 xl:py-6 mt-2.5 lg:mt-10">
                        <button type="submit"
                            class="w-full px-5 py-3 mb-2 text-xs font-medium text-center text-gray-900 transition-all duration-300 ease-in-out bg-yellow-300 rounded-full shadow-lg xl:py-4 hover:bg-yellow-400 me-2 xl:text-base">Login</button>
