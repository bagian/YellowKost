                    ...
                    <div class="p-5 space-y-6 border-t border-gray-100 sm:p-6 dark:border-gray-500">
                        <div class="grid grid-cols-1 gap-4 mb-4 md:grid-cols-2">
                            ...
                            <div class="mb-4">
                                ...
                                <input type="text" name="price" placeholder="Harga Sewa" maxlength="16"
                                    value="{{ $room->price }}" placeholder="Harga Sewa" inputmode="numeric"
                                ...
                                <div class="swiper">
                                    ...
                                    <div class="swiper-wrapper">
                                        ...
                                        @foreach ($room->pictures as $row)
                                            <div
                                                class="@if ($loop->first) relative overflow-hidden @endif swiper-slide">
