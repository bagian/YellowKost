                                    ...
                                    <div class="p-4 space-y-4 md:p-5 swiper-container-{{ $row->id }}">
                                        <div class="swiper">
                                            <div class="swiper-wrapper">
                                                ...
                                                <div class="w-full h-64 swiper-slide">
                                                    <img src="{{ Storage::url($picture->url) }}"
                                                        alt="{{ $picture->name }}" class="object-cover w-full h-96">
                                                </div>
                                                @endforeach
                                            </div>
                    ...
                    <td class="px-6 py-4">
                        <div class="flex items-center gap-2">
                            ...
                            <button type="button" name="delete" data-href="{{ route('kamar.destroy' , $row->id) }}"
                                data-name="Kamar {{ $row->room_name }}" class="flex flex-row items-center gap-2 p-2 text-white duration-300 ease-in-out
