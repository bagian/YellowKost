                        ...
                        <div class="description-container space-y-6 md:col-span-2">
                            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                                ...
                                <div>
                                    ...
                                    <p id="total_paid" class="text-lg font-medium text-gray-900 dark:text-white">-
                                    </p>
                                </div>
                                <div>
            ...
            <div
                                            ...
                                            <div
                                                ...
                                                <span class="flex items-center gap-1">
                                                    <svg class="w-5 h-5" fill="currentColor"
                                                        xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">me.com
                ...
                <div
                    ...
                    <span class="block mb-4 text-sm text-gray-700 dark:text-gray-400 md:mb-0">
                        Menampilkan <span class="mx-1 font-semibold text-white">{{ $booking->firstItem() ?? 0 }}</span> sampai
...
@push('scripts')
    ...
    <div>
        ...
        <div class="description description-confirmed p-5 mt-6 border-l-4 border-green-500 bg-green-50 dark:bg-green-900/20 rounded-r-xl">
            <div class="flex">
                <div class="flex-shrink-0">
