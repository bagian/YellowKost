    ...
    <div class="min-h-screen p-6 md:p-10 max-w-5xl mx-auto text-gray-800 dark:text-gray-200">
        ...
        @else
            ...
            <div
                ...
                <div
                    class="badge-container bg-gray-50 dark:bg-gray-700/50 px-6 py-5 border-b border-gray-100 dark:border-gray-700 flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
                    <div>
                ...
                --}}
                        <h3 id="id_booking" class="text-xl font-bold text-gray-900 dark:text-white font-mono">
                            -
                        </h3>
                    </div>
                ...
                <div class="p-6 md:p-8">
                    <div class="description-container grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div class="md:col-span-2 space-y-6">
                            <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <p id="room_name" class="font-medium text-gray-900 dark:text-white text-lg">
                                        -
                                    </p>
                                </div>
                                <div>
                                    <p class="text-xs font-semibold uppercase text-gray-400 mb-1">Tanggal Masuk</p>
                                    <p id="check_in" class="font-medium text-gray-900 dark:text-white text-lg">
                                        -
                                    </p>
                                </div>
                                <div>
                                    <p class="text-xs font-semibold uppercase text-gray-400 mb-1">Total Biaya</p>
                                    <p id="total_paid" class="font-medium text-gray-900 dark:text-white text-lg">
                                        -
                                    </p>
                                </div>
                                <div>
                                    <p class="text-xs font-semibold uppercase text-gray-400 mb-1">Tanggal Pengajuan</p>
                                    <p id="created_at" class="font-medium text-gray-900 dark:text-white text-lg">
                                        -
                                    </p>
                                </div>
                            </div>
                            ...
                            @foreach ($booking as $row)
                                <tr
                                    ...
                                    <td class="px-6 py-4 text-gray-500 truncate max-w-xs">
                                        <button data-id="{{ $row->id }}" onclick="detailPengajuan(this.dataset.id)" name="btnDetail"
...
<script type="text/html" id="listBadge">
    <div>
        <span
            class="badge badge-pending inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-yellow-100 text-yellow-700 border border-yellow-200">
        ...
        <span
            class="badge badge-confirmed inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-green-100 text-green-700 border border-green-200">
        ...
        <span
            class="badge badge-cancelled inline-flex items-center px-4 py-2 rounded-full text-sm font-bold bg-red-100 text-red-700 border border-red-200">
            <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
...
<script type="text/html" id="detailDescription">
    <div>
        <div
            class="description description-cancelled mt-6 bg-red-50 dark:bg-red-900/20 border-l-4 border-red-500 p-5 rounded-r-xl animate-fade-in">
            <div class="flex items-start">
                ...
                <div class="ml-4 w-full">
                    ...
                    <div
                        ...
                        <span id="notes" class="font-semibold block mb-1">Alasan dari Admin:</span>
        ...
        <div
            class="description description-confirmed mt-6 bg-green-50 dark:bg-green-900/20 border-l-4 border-green-500 p-5 rounded-r-xl">
            <div class="flex">
                <div class="flex-shrink-0">
...
<script type="text/html" id="statusVisual">
    <div>
        <div
            class="visual visual-confirmed w-24 h-24 bg-green-100 dark:bg-green-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div
            class="visual visual-cancelled w-24 h-24 bg-red-100 dark:bg-red-900/30 rounded-full flex items-center justify-center mx-auto mb-4">
        ...
        <div
            class="visual visual-pending w-24 h-24 bg-yellow-100 dark:bg-yellow-900/30 rounded-full flex items-center justify-center mx-auto mb-4 animate-pulse">
