...
<head>
    ...
    <meta name="description"
        content="Solusi manajemen kost all-in-one. Pantau penyewa, ketersediaan kamar, keuangan, dan laporan operasional secara real-time. Semuanya terpusat di Dashboard YellowKost.">
    <meta name="keywords"
    ...
    <meta property="og:description"
        content="Pantau dan kelola semua aspek bisnis kost Anda: penyewa, kamar, keuangan, dan lainnya. Solusi cerdas untuk pemilik kost modern.">
    <!-- Ganti dengan URL gambar preview website Anda (ukuran rekomendasi 1200x630) -->
    <meta property="og:image" content="{{ asset('images/og-yellowkost-dashboard.jpg') }}">
