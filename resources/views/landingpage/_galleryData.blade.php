<div class="swiper mySwiper">
    ...
    <div class="relative mx-auto max-w-[14rem]">
        <div
            class="absolute items-center justify-center p-2 px-6 border border-yellow-200 rounded-full swiper-pagination bg-white/30 backdrop-blur-xl drop-shadow-xl">
        </div>
    </div>
    <div class="mx-auto xl:mr-16 swiper-button-next important"></div>
    <div class="mx-auto xl:ml-16 swiper-button-prev important"></div>
</div>