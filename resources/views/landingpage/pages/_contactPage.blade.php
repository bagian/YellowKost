...
<div class="max-w-7xl px-6 mx-auto">
    ...
    <section class="py-16 -mt-10 relative z-10 rounded-t-[3rem]">
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-12 lg:gap-5">
            <div class="lg:col-span-1 space-y-5">
                <div class="bg-gray-800 p-8 rounded-xl border border-gray-700 shadow-sm">
                ...
                <div class="rounded-xl overflow-hidden shadow-lg border border-gray-700 h-[17.3rem]">
                    <iframe
            ...
            <div class="lg:col-span-2">
                <div class="bg-gray-800 p-8 md:p-12 rounded-xl shadow-lg">
