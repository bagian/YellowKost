...
<aside id="logo-sidebar"
    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-gray-50 dark:bg-gray-800">
        <ul class="space-y-2 font-medium">
            ...
            @elseif(Auth::user()->role->slug === 'user' || Auth::user()->role->slug === 'superadmn')
                <x-sidebar-link route="upload.bukti" title="Unggah Pembayaran">
                    <svg class="w-full h-full" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                        <path
                ...
                <x-sidebar-link route="testimonial" title="Testimonial"> <svg class="w-full h-full" fill="currentColor"
                ...
                <x-sidebar-link route="status.pengajuan" title="Pengajuan Sewa">
                    <svg class="w-full h-full" fill="currentColor" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640">
                        <path
            ...
            <div class="pt-5">
                <span
                    class="block px-2 pt-4 text-xs text-gray-500 uppercase border-t border-gray-200 dark:border-gray-700 py-3">Support</span>
                @if(Auth::user()->role->slug === 'admin' || Auth::user()->role->slug === 'superadmin')
                ...
                <div class="mt-2">
                    <x-sidebar-link route="#" title="Pesan Masuk" class="md:hidden block">
                        <svg class="w-full h-full" fill="currentColor" xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 640 640">
                            <path
