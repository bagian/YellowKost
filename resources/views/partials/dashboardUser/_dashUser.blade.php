...
@elseif(!$payments->isEmpty() &&now()->diffInDays($dueDateDate) <= 7) {{-- 1 Minggu Jatuh Tempo --}}
    ...
    <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div class="lg:col-span-2 space-y-6">
            <div
                class="p-6 border border-gray-200 rounded-2xl shadow-lg  bg-white dark:bg-gray-100 dark:border-gray-300">
        ...
        <div class="space-y-6">
            ...
            <div
                class="bg-gradient-to-br from-yellow-600 to-yellow-700 rounded-2xl shadow-lg p-6 text-white text-center">
