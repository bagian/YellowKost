...
<body class="font-sans antialiased">
    <div
        ...
        <div class="p-8 text-center">
            <h1 class="font-bold text-indigo-600 text-8xl md:text-[16rem] dark:text-indigo-400">400</h1>
            <h2 class="mt-4 text-2xl font-semibold tracking-tight md:text-4xl">Permintaan Tidak Valid</h2>
            <p class="max-w-lg mt-2 text-base text-gray-600 dark:text-gray-400">
                Maaf, server tidak dapat memproses permintaan Anda karena format yang salah atau tidak valid.
            </p>
            <a href="{{ url('/') }}"
