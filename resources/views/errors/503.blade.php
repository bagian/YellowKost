...
<body class="font-sans antialiased">
    <div
        ...
        <div class="p-8 text-center">
            <h1 class="font-bold text-indigo-600 text-8xl md:text-[16rem] dark:text-indigo-400">503</h1>
            <h2 class="mt-4 text-2xl font-semibold tracking-tight md:text-4xl">Layanan Tidak Tersedia</h2>
            <p class="max-w-lg mt-2 text-base text-gray-600 dark:text-gray-400">
                Maaf, server saat ini tidak dapat menangani permintaan karena sedang dalam pemeliharaan atau kelebihan
                beban. Silakan coba lagi nanti.
            </p>
