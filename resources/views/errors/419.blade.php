...
<head>
    ...
    <title>419 Page Expired - Halaman Kadaluarsa</title>
...
<body class="font-sans antialiased">
    <div
        ...
        <div class="p-8 text-center">
            <h1 class="font-bold text-indigo-600 text-8xl md:text-[16rem] dark:text-indigo-400">419</h1>
            <h2 class="mt-4 text-2xl font-semibold tracking-tight md:text-4xl">Halaman Kadaluarsa</h2>
            <p class="mt-2 text-base text-gray-600 dark:text-gray-400">
                Maaf, sesi Anda telah berakhir. Silakan segarkan halaman dan coba lagi.
            </p>
            <a href="{{ url()->previous() }}"
