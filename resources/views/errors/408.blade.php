...
<head>
    ...
    <title>408 Request Timeout - Waktu Permintaan Habis</title>
...
<body class="font-sans antialiased">
    <div
        ...
        <div class="p-8 text-center">
            <h1 class="font-bold text-indigo-600 text-8xl md:text-[16rem] dark:text-indigo-400">408</h1>
            <h2 class="mt-4 text-2xl font-semibold tracking-tight md:text-4xl">Waktu Permintaan Habis</h2>
            <p class="max-w-lg mt-2 text-base text-gray-600 dark:text-gray-400">
                Maaf, server membutuhkan waktu terlalu lama untuk merespons. Ini mungkin karena koneksi yang lambat.
